...
>
> **ยังไม่ได้แก้** — ต้องมี job ที่ build จากศูนย์เป็นระยะ (ไม่ใช้ cache)
> ไม่งั้นรูปแบบนี้จะกลับมาอีกกับ crate ตัวถัดไป · รูปเดียวกับ `gles`
> ที่หายไปโดยบังเอิญแล้วต้องมีประตูมาตรึงทีหลัง
