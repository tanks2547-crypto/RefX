...
| P5-7 | เอกสารผู้ใช้ + คู่มือคีย์ลัด · **+ รายการ "ข้อจำกัดที่รู้อยู่"** |
...
> | **ชื่อ native dialog 5 อัน** | ยังเป็นไทย · **ชั้นนี้แปลได้จริง** (ผู้เรียกอยู่ใน `refx-ui` ที่มี `text::`) → ต้องรับ `title: &str` **ไม่ใช่เปลี่ยนเป็นอังกฤษตายตัว** = แก้ลายเซ็น 4 ฟังก์ชัน · ทำใน P5-7 |
...
| **b** | คิวบั๊กที่ค้าง | เสถียรมาก่อนขนาดและก่อนแพ็กเกจ — ห้ามแพ็กของที่รู้ว่าพัง |
| **c** | ลดขนาด binary (รายการด้านล่าง) | ต้องวัดกับ binary ที่พฤติกรรมนิ่งแล้ว |
| **d** | แพ็กเกจ MSI / zip / AppImage / deb | ปลายทาง |
