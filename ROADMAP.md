...
> ### P5-8: ทำไม atlas dedupe ต้องมีรอบของตัวเอง (แยก 14 ก.ย. 2026)
>
...
>
> ### ★ ผิวข้อความที่ยังเหลือ (เจอตอน P5-6 ก้อน b ข้อ 3 · 14 ก.ย. 2026)
>
> | ผิว | สถานะ |
> |---|---|
...
> | ~~**ชื่อ native dialog 5 อัน**~~ | ✅ **เสร็จ 14 ก.ย. 2026** — รับ `title: &str` แล้ว ผู้เรียกส่งข้อความที่แปลแล้วเข้าไป · `pick_missing_image` บอกชื่อไฟล์บนหัวกล่องเมื่อรู้ชื่อ |
...
### ★★★ P5-6 แบ่งสี่ก้อน — ลำดับนี้บังคับ (13 ก.ย. 2026)
...
> ### ★★★ ก้อน b ข้อ 2 ปิดแล้ว — `WM_INPUTLANGCHANGEREQUEST` (14 ก.ย. 2026)
>
...
* ★ **ประตู** — ~~ไฟล์ต้องใหม่กว่า `Cargo.lock`~~ **ผมเขียนผิด แก้ 14 ก.ย. 2026**
...
>
> **แก้แล้ว 18 ก.ย. 2026** — `.github/workflows/cold-build.yml` build จากศูนย์
...
ค่าปัจจุบัน **17.9 MB / เพดาน 25 MB** (วัด 14 ก.ย. 2026 — ตัวเลข 15.37 MB
...
## v1.1 — backlog ทั้งหมด **อ่านจบในหน้าเดียว** (ปรับ 24 ก.ย. 2026)
