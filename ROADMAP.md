...
| P5-6 | Binary hardening + packaging | ✅ **เกือบครบ (14 ก.ย. 2026)** — ขนาด 17.92 → 17.34 MB · zip · MSI · `.deb` พร้อมประตูสองบานที่ NC พิสูจน์แล้ว · **AppImage ติดที่ไม่มีไอคอน** (ดูกล่องล่าง) · ★★★ บั๊ก `WM_INPUTLANGCHANGEREQUEST` ปิดแล้ว — ตัวการคือ backend `gles` |
| P5-7 | เอกสารผู้ใช้ + คู่มือคีย์ลัด · **+ รายการ "ข้อจำกัดที่รู้อยู่"** | 🔄 `KEYBOARD-SHORTCUTS.md` (สร้างจากตารางจริง + ประตู) · `KNOWN-LIMITATIONS.md` · ชื่อ native dialog แปลได้แล้ว |
