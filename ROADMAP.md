...
### ★★★ P5-4b: ทำไม export ยังปิดไม่ได้ (แยกออกมา 9 ก.ย. 2026)

พิกเซลของภาพที่ส่งออกวันนี้มาจาก **atlas ซึ่งเป็น thumbnail 128×128**

| ขนาดที่ export | ภาพหนึ่งใบกว้างราว | |
|---|---|---|
| 2048 | ~95 จุด | ✅ |
| 4096 | ~190 จุด | ⚠️ ขยาย 1.5 เท่า |
| 16384 | ~760 จุด | ❌ **ขยาย 6 เท่า** |

> ### ทางที่ **ห้าม** เลือก: ใช้ texture ที่บังเอิญค้างอยู่ (T1 working texture)
> มันขึ้นกับว่าผู้ใช้เพิ่งซูมดูภาพไหน → **board เดียวกัน ตั้งค่าเดียวกัน
> ส่งออกสองครั้งได้คนละผล** · ผลที่ทำซ้ำไม่ได้แย่กว่าผลที่นุ่มสม่ำเสมอมาก
> เพราะผู้ใช้จะไม่มีวันรู้ว่าเชื่อไฟล์ไหนได้

**สิ่งที่ต้องสร้าง:** แหล่งพิกเซลของ export เอง — ถอดรหัสต้นฉบับที่ความละเอียด
ของ export แล้วสตรีมเข้า texture ทีละแถบ พร้อม LRU + ยกเลิก + I-7

**ระหว่างที่ยังไม่มี:** เพดานขนาดคำนวณจากพิกเซลที่มีจริง — ดู `docs/07 §6`
