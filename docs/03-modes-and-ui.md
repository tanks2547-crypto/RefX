...
> ### ⚠️ สถานะจริง 29 ส.ค. 2026 — ตารางนี้มี 17 คีย์ แต่ทำจริง 11
>
> **ไม่เคยมีเลย 6 ตัว:** `Tab` (สลับโหมด) · `Ctrl+A` · `Esc` · `F` · `1` · `0`
> — grep แล้วไม่มีที่ไหนเลย · การสลับโหมดทำได้ทางปุ่ม toolbar อย่างเดียว
>
> และ **ไม่มี keymap table เลย** — ทุกคีย์เป็น `if key == ...` กระจายใน `on_input`
> (10 ฟังก์ชัน · 164 บรรทัด dispatch · alias อักขระ control hard-code 7 จุด)
> ซึ่งเป็นสิ่งที่ย่อหน้าข้างล่างห้ามไว้ตรง ๆ มาตั้งแต่วันแรก
>
> P5-3 แก้ข้อนี้ — **แต่แยกเป็นสองก้อน** (ดู `ROADMAP` P5-3)
