...
> ### ⏳ ยังเหลือ: กล้อง (zoom/pan) ยังไม่ถูกอ่านกลับตอนเปิดไฟล์
> `view` ถูก**บันทึกลงไฟล์แล้ว** แต่เปิดมาได้ zoom ค่าปริยายเสมอ
> → เราเก็บของของผู้ใช้ไว้แล้วไม่คืนให้ ซึ่งแย่กว่าไม่เก็บ เพราะไฟล์อ้างว่ามี
> **ต้องปิดก่อน P5-4**
