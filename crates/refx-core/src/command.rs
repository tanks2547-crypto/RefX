...
pub enum MetaField {
    ...
    /// ปักหมุด
    Pinned,
    /// ★★★ คืนค่าทั้งชุดจาก `.refx-meta` (P5-5)
    ///
    /// แยกจากช่องอื่นเพราะมันแก้ **หลายช่องพร้อมกัน** — ถ้ายืมชื่อช่องใดช่องหนึ่ง
    /// มาใช้ การคืนค่าจะ merge เข้ากับสิ่งที่ผู้ใช้เพิ่งแก้ด้วยมือ แล้ว `Ctrl+Z`
    /// ทีเดียวจะย้อนทั้งสองอย่างโดยที่เขาเห็นแค่อย่างเดียว
    Restored,
}
