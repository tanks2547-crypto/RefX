#![no_main]
//! ★ ยังไม่ได้ต่อ — โค้ดที่ต้องยิงยังไม่มีตัวตน (refx_io::dto)
//!
...
//!
//! **เมื่อ `refx_io::dto` มีของจริงแล้ว ต้องทำสามอย่างพร้อมกัน:**
...
//! สิ่งที่ต้องยิงเมื่อพร้อม: `.refx` ที่ถูกดัดแปลงต้องคืน Err — ห้าม panic
//! และห้ามจอง memory ตามตัวเลขที่อยู่ในไฟล์ (T3, docs/07 §2)
