...
`nextest 488/488` / `deny check` ครบ 4 หมวด (advisories · bans · licenses · sources) /
**binary 15.86 MB จากเพดาน 25 MB (บังคับใน CI · negative control ยังล้มเป็น)** /
...
| **หัวข้อ `X / Y / W / H` ใน Inspector ยังไม่มีตัวเลข** | เห็นตอนถ่ายภาพหลักฐาน P2-9: หัวข้อสัญญาว่าจะบอกพิกัด/ขนาด แต่ข้างล่างมีแต่ opacity/filter · ทำให้ต้องวัดตำแหน่งจากพิกเซลบนภาพหน้าจอแทนที่จะอ่านจากจอตรง ๆ · **ยังไม่ตัดสินว่าจะเติมช่องหรือแก้หัวข้อ** — เป็นเรื่องของ P2-10/P3-1 ที่ทำ inspector เต็ม |
