...
| **P2-4** select / rubber-band / multi-select | ✅ เสร็จ (`dd51d60` · `439f380` · `a6ac127`) — canvas เป็น widget จริงแล้ว ยืนยันด้วยภาพหน้าจอ |
...
3. ← **เริ่มที่นี่** ต่อ Ctrl+Z/Ctrl+Y เข้า `History` แล้วเอา id จาก `undo()`/`redo()`
   ไปตั้ง selection · แล้วขึ้น P2-5 (move/scale/rotate + snap)
